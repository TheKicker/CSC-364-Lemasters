...
class createProdTemplate extends templateEngine
{
    /**
    ...
    public function createProd()
    {
      ...
      $price = $data['price'];
        ...
        <div align:center style="padding-top: 48px; padding-left: 36px; padding-right: 36px;">
              <form id="createPostForm" action='createProd.php' method="POST" class="form-horizontal" enctype="multipart/form-data">
                                <fieldset>
                                    <!-- Form Name -->
