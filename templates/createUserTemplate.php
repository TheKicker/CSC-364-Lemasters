...
class createUserTemplate extends templateEngine
{
    ...
    public function createUser()
    {
      ...
      // Hashing password for security within Database
                ...
                <div class="row justify-content-center" style="padding-top:15px;">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="address" name="address" type="text" value="$address" class="form-control here" placeholder="1001 Main Street, Apartment 1">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="billing_address" name="billing_address" type="text" value="$billAddress" class="form-control here" placeholder="1001 Main Street, Apartment 2">
                            </div>
                        </div>
